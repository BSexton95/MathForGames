...
namespace MathForGames
{
    public struct Matrix3
    {
        ...
        /// <returns></returns>
        public static Matrix3 CrreateRotation(float radians)
        {
        ...
        /// <param name = "y" >The y position of the new matrix
        /// <returns></returns>
        ...
        /// <param name ="y">The value to use to cale the matrix in the y axis</param>

...
namespace MathForGames
{
    class Engine
    {
        ...
        private void Start()
        {
            ...
            player.SetColor(new Vector4(10, 150, 150, 255));

            Actor enemy = new Actor(1, 1, "Enemy", Shape.CUBE);
            enemy.SetScale(1, 1, 1);
            enemy.LookAt(new Vector3(1, 0, 1));
            enemy.SetColor(new Vector4(10, 250, 50, 255));
            /*
            //Player's collider
